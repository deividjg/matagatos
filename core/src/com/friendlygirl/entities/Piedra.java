...
public class Piedra extends Actor {
    ...
    public Piedra(World world, Texture texture, Vector2 posicion) {
    ...
    public void draw(Batch batch, float parentAlpha) {
        setPosition((body.getPosition().x - 0.2f) * PIXELS_EN_METROS, (body.getPosition().y - 0.2f) * PIXELS_EN_METROS);
        batch.draw(texture, getX(), getY(), getWidth(), getHeight());
    }

    @Override
    public void act(float delta) {
        body.applyForceToCenter(40, 40, true);
    }
